package com.tabio.tabioapp.ui.widget.card;
...
public class CardCollectionView extends RelativeLayout {
    public static final String TAG = makeLogTag(CardCollectionView.class);
    ...
    public CardCollectionView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//            array.recycle();
    ...
    private void setupAnimation(){
        ...
        final DragGestureDetector dd = new DragGestureDetector(CardCollectionView.this.getContext(),new DragGestureDetector.DragListener(){
    ...
    public ArrayList<View> viewCollection = new ArrayList<View>();
